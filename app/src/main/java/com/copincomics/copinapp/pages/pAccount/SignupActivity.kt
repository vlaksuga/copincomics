...
import kotlinx.android.synthetic.main.activity_loigin.progress_bar
import kotlinx.android.synthetic.main.activity_signup.*
import kotlinx.android.synthetic.main.merge_top_title_with_finishbtn.*
import java.util.regex.Pattern

class SignupActivity : BaseAccount(), View.OnClickListener {
    ...
    lateinit var signup_agree_terms_chk: CheckBox
    lateinit var signup_agree_personal_terms_chk: CheckBox
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        signup_agree_terms_chk = findViewById<CheckBox>(R.id.signup_agree_terms_chk)
        signup_agree_personal_terms_chk = findViewById<CheckBox>(R.id.signup_agree_personal_terms_chk)
        signup_agreeall_chk.setOnClickListener {
            signup_agree_terms_chk.isChecked = true
            signup_agree_personal_terms_chk.isChecked = true
        }
    ...
    override fun onClick(v: View) {
        if (!(signup_agree_terms_chk.isChecked && signup_agree_personal_terms_chk.isChecked)) {
            Toast.makeText(
                baseContext, "Please agree on the terms and conditions",
                Toast.LENGTH_SHORT
            ).show()
        } else {
            when (v.id) {
